...
export function ActionSection() {
  return (
    <section className="flex flex-col bg-[url('/action-background.svg')] ">
      <span className="p-4 self-center mt-[-1.5rem] rounded-full bg-cyan-300">
        <StoreIcon className="text-cyan-100" width={32} height={32}/>
      </span>
      <div className="container pt-20 pb-20 flex flex-col gap-12 text-gray-100 items-center justify-center">
        <span className="flex flex-col items-center text-heading-xl">
